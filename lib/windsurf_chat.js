...
function readPort() {
  ...
  console.log(`[WindsurfChat] 使用端口文件: ${portFile}`);
...
async function main() {
  ...
  console.log(`[WindsurfChat] 使用端口: ${port}`);
  console.log(`[WindsurfChat] 正在连接到 http://127.0.0.1:${port}/request ...`);
